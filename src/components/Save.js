...
return( 
    <> 
    <Base thead=' SAVE CONTECTS   -  India vs Australia' tstyle='headstyle'footer='foot' children={ 
        
       <div> <div className="bh" style={{gap:'20px'}}><Button onClick={()=>history('/Add')}>add</Button> 
        ...
        <Button onClick={()=>{edit(ell.id); history('/Edit')}}>edit</Button>  
